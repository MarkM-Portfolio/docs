...
java -Xms1024m -Xmx2048m  -cp "../shrinksafe/js.jar";"../shrinksafe/shrinksafe.jar" org.mozilla.javascript.tools.shell.Main  "../../dojo/dojo.js" baseUrl="../../dojo" load=build %*

@rem java -classpath ../shrinksafe/js.jar;../shrinksafe/shrinksafe.jar org.mozilla.javascript.tools.shell.Main build.js %*

@rem java -Xms256m -Xmx512m -classpath ../shrinksafe/js.jar;../shrinksafe/shrinksafe.jar org.mozilla.javascript.tools.shell.Main  build.js %*
