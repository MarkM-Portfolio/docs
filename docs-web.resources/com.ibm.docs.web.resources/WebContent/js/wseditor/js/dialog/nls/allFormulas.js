...
({
    ...
    ACOT:{    
    	Syntax:"${0}(number)",
        Disp:"Returns the inverse cotangent of a number. The angle is measured in radians."
    },
    ACOTH:{    
    	Syntax:"${0}(number)",
        Disp:"Returns the inverse hyperbolic cotangent of a number."
    },
    ADDRESS:{
    ...
    AVERAGEIF:{    
    	...
    	Disp:"Returns the average (arithmetic mean) of the arguments that meet the given condition."
    },
    AVERAGEIFS:{    
    	Syntax: "${0}(average_range${1} criteria_range1${1} criteria1${1} ...)",
    	Disp:"Returns the average (arithmetic mean) of the arguments that meet multiple conditions."
    },
    ATAN2:{
    ...
    BIN2DEC:{
    	Syntax:"${0}(number)",
    	Disp:"Converts a binary number to a decimal number."
    }, 
    BIN2HEX:{
    	Syntax:"${0}(number${1} [places])",
    	Disp:"Converts a binary number to a hexadecimal number."
    }, 
    BIN2OCT:{
    	Syntax:"${0}(number${1} [places])",
    	Disp:"Converts a binary number to an octal number."
    },
    CEILING:{  
    ...
    COT:{    
    	Syntax:"${0}(number)",
        Disp:"Returns the cotangent of the given number."
    },
    COTH:{    
    	Syntax:"${0}(number)",
        Disp:"Returns the hyperbolic cotangent of the given number."
    },
    COUNT:{   
    ...
    COUNTIF:{
    	...
    	Disp:"Counts the number of cells that meet the given condition."
    },
    COUNTIFS:{
    	Syntax: "${0}(criteria_range1${1} criteria1${1} ...)",
    	Disp:"Counts the number of cells that meet multiple conditions."
    },
    CUMIPMT:{	
	    Syntax:"${0}(rate${1} nper${1} pv${1} start_period${1} end_period${1} type)",
	    Disp:"Calculates the cumulative interest paid between two specified periods."
    },
    CUMPRINC:{	
	    Syntax:"${0}(rate${1} nper${1} pv${1} start_period${1} end_period${1} type)",
	    Disp:"Calculates the cumulative principal paid on a loan, between two specified periods."
    }, 
    DATE:{	
    ...
    DEC2BIN:{
    	Syntax:"${0}(number${1} [places])",
    	Disp:"Converts a decimal number to a binary number."
    }, 
    DEC2HEX:{
    	Syntax:"${0}(number${1} [places])",
    	Disp:"Converts a decimal number to a hexadecimal number."
    },
    DEC2OCT:{
    	Syntax:"${0}(number${1} [places])",
    	Disp:"Converts a decimal number to an octal number."
    },
    DEGREES:{	
	    Syntax:"${0}(angle)",
    ...
    DISC:{
    	...
    	Disp:"Calculates the discount rate for a security."
    }, 
    DOLLAR:{
    ...
    EDATE:{
    	...
    	Disp:"Returns the serial number that represents the date that is the indicated number of months before or after start_date "
    },
    EOMONTH:{
    	Syntax:"${0}(start_date${1} months)",
    	Disp:"Returns the serial number for the last day of the month that is the indicated number of months before or after start_date"
    },
    ERFC:{   
    	Syntax:"${0}(number)",
        Disp:"Returns the complementary error function, integrated between a number and infinity."
    },
    "ERROR.TYPE":{    
    	Syntax:"${0}(reference)",
...
//        }
    ...
    FACTDOUBLE:{  
    	Syntax:"${0}(number)",
        Disp:"Returns the double factorial of a number."
    },
    FALSE:{
    	Syntax:"${0}()",
    ...
    FV:{
    	...
    	Disp:"Calculates the future value of an investment based on a constant interest rate."
    },
    FVSCHEDULE:{    
    	Syntax:"${0}(principal${1} schedule)",
        Disp:"Calculates the future value of an initial principal, after applying a series of compound interest rates."
    },
    GAMMALN:{   
    	Syntax:"${0}(number)",
        Disp:"Returns the natural logarithm of the gamma function."
    },
    GCD:{   
    	Syntax:"${0}(number1${1} [number 2]${1} ...)",
        Disp:"Returns the greatest common divisor of all arguments."
    },
    HEX2BIN:{
    	Syntax:"${0}(number${1} [places])",
    	Disp:"Converts a hexadecimal number to a binary number."
    }, 
    HEX2DEC:{
    	Syntax:"${0}(number)",
    	Disp:"Converts a hexadecimal number to a decimal number."
    }, 
    HEX2OCT:{
    	Syntax:"${0}(number${1} [places])",
    	Disp:"Converts a hexadecimal number to an octal number."
    },
    HOUR:{   
    	Syntax:"${0}(number)",
    ...
    HYPERLINK:{    
    	...
    	Disp:"Returns a link that points to a network resource or to a range referenced by the link. Displays cell_text (optional) if provided; otherwise, displays the link as text."
    },    
    IF:{    
    ...
    IFS:{
    	...
    	Disp:"Runs logical tests to check whether one or more conditions are met and returns a value that matches the first TRUE condition."
    },
    IFERROR:{
    	Syntax:"${0}(value${1} value_if_error)",
    	Disp:"Returns the value that you specify if expression is an error. Otherwise, returns the result of the expression."
    },
    IFNA:{
    	Syntax:"${0}(value${1} value_if_na)",
    	Disp:"Returns the value that you specify if expression returns the #N/A error value. Otherwise, returns the result of the expression."
    },
    INDEX:{    
    ...
    IPMT:{
    	...
    	Disp:"Calculates the interest repayment amount for a period for an investment based on regular payments and a fixed interest rate."
    }, 
    ISBLANK:{   
    	Syntax:"${0}(value)",
    ...
    ISPMT:{
    	...
    	Disp:"Calculates the interest paid during a specified period for an investment."
    }, 
    ISREF:{    
    	Syntax:"${0}(value)",
    ...
    LCM:{   
    	Syntax:"${0}(number1${1} [number 2]${1} ...)",
        Disp:"Returns the lowest common multiple of all numbers in the list."
    },
    LEFT:{
    ...
    MROUND:{   
        ...
        Disp:"Returns a number rounded to a specified multiple."
    },
    MMULT:{    
    ...
    MULTINOMIAL:{   
    	Syntax:"${0}(number1${1} [number 2]${1} ...)",
        Disp:"Returns the multinomial coefficient of a set of numbers."
    },
    N:{    
    	Syntax:"${0}(value)",
    ...
    NPV:{   
        ...
        Disp:"Calculates the net present value of an investment, based on a supplied discount rate, and a series of future payments and income."
    },
    OCT2BIN:{
    	Syntax:"${0}(number${1} [places])",
    	Disp:"Converts an octal number to a binary number."
    },
    OCT2DEC:{
    	Syntax:"${0}(number)",
    	Disp:"Converts an octal number to a decimal number."
    },
    OCT2HEX:{
    	Syntax:"${0}(number${1} [places])",
    	Disp:"Converts an octal number to a hexadecimal number."
    },
    ODD:{    
    	Syntax:"${0}(number)",
    ...
    PMT:{
    	...
    	Disp:"Returns the payment for a loan based on regular payments and a fixed interest rate."
    },
    POWER:{    
    ...
    PPMT:{
    	Syntax:"${0}(rate${1} per${1} nper${1} pv${1} [fv]${1} [type])",
    	Disp:"Calculates the repayment amount for a period for an investment based on regular payments and a fixed interest rate."
    },
    PRICEDISC:{
    	Syntax:"${0}(settlement${1} maturity${1} discount${1} redemption${1} [basis])",
    	Disp:"Calculates the price per $100 face value of a discounted security."
    },
    PRICEMAT:{
    	Syntax:"${0}(settlement${1} maturity${1} issue${1} rate${1} yld${1} [basis])",
    	Disp:"Calculates the price per $100 face value of a security that pays interest at maturity."
    },
    PRODUCT:{   
    	Syntax:"${0}(number 1${1} [number 2]${1} ...)",
    ...
    PV:{
    	...
    	Disp:"Calculates the present value of an investment, based on a series of future payments."
    }, 
    QUOTIENT:{    
    	Syntax:"${0}(numerator${1} denominator)",
        Disp:"Returns the result of a number divided by another number, truncated to an integer."
    },
    RAND:{
    	Syntax:"${0}()",
    ...
    RECEIVED:{
    	...
    	Disp:"Calculates the amount received at maturity for a fully invested security."
    }, 
    REPLACE:{    
    ...
    SIGN:{    
    	Syntax:"${0}(number)",
        Disp:"Returns the algebraic sign of a number."
    },
    SIN:{    
    	Syntax:"${0}(number)",
    ...
    SERIESSUM:{    
        ...
        Disp:"Returns the sum of a power series based on the formula."
    },
    SHEET:{   
    	Syntax:"${0}([reference])",
    ...
    SUMIFS:{
    	...
    	Disp:"Totals the arguments that meet multiple conditions."
    },
    SQRT:{   
    	Syntax:"${0}(number)",
    ...
    SQRTPI:{   
    	Syntax:"${0}(number)",
        Disp:"Returns the square root of (number * pi)."
    },
    STDEV:
    {
    	Syntax:"${0}(number 1${1} [number 2]${1} ...)",
    ...
    SUMSQ:{
    	Syntax:"${0}(number 1${1} [number 2]${1} ...)",
        Disp:"Returns the sum of the squares of the numbers in the list."
    },
    T:{
    	Syntax:"${0}(text)",
    ...
    TAN:{    
    	Syntax:"${0}(number)",
        Disp:"Returns the tangent of the given number."
    },
    TANH:{    
    	Syntax:"${0}(number)",
        Disp:"Returns the hyperbolic tangent of the given number."
    },
    TBILLPRICE:{
    	Syntax:"${0}(settlement${1} maturity${1} discount)",
    	Disp:"Calculates the price per $100 face value for a Treasury bill."
    },
    TEXT:{
    ...
    XNPV:{   
    	...
    	Disp:"Calculates the net present value for a schedule of cash flows."
    },
    YEAR:{    
    	Syntax:"${0}(number)",
