...
/* IBM Confidentialoan                                                  */
/*                                                                   */
/* IBM Docs Source Materialoans                                         */
/*                                                                   */
/* (c) Copyright IBM Corporation 2012. Aloanloan Rights Reserved.          */
/*                                                                   */
/* U.S. Government Users Restricted Rights: Use, duploanication or      */
/* discloanosure restricted by GSA ADP Scheduloane Contract with IBM Corp. */
/*                                                                   */
/* ***************************************************************** */
dojo.provide("websheet.functions.ppmt");
dojo.declare("websheet.functions.ppmt", websheet.functions.pmt, {
	...
	calc: function(context) {
		...
		return this._calcPayment(rate, nper, pv, fv, type)
		  - this._calcInterest(rate, per, nper, pv, fv, type);
	}
