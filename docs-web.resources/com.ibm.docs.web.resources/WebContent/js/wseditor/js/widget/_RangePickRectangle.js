...
/*                                                                   */
/* ***************************************************************** */
dojo.provide("websheet.widget._RangePickRectangle");
dojo.require("websheet.widget._SelectRectangle");

dojo.declare("websheet.widget._RangePickRectangle", [websheet.widget._SelectRectangle], {
	// summary:
	//		Used for formula editing, chart data source editing etc.
	...
	destroyRecursive: function () {
		// summary:
		//		Overwrite for the same reason as 'destroy'
	},
	...
	isActivated: function () {
		// summary:
		//		Activated means if current rectangle should handle the mouse events the data grid delievered.
		// overwrite, range picker's activated status is marked with "_isPickingRange"
		// while Select rectangle's activated stauts is marked with "_isSelecting".
