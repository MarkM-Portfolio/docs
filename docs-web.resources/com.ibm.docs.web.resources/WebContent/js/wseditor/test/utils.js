...
(function(runner) {
	...
	var bindDocument = function(doc) {
		runner.builders.object([[ "app.websheet.Main.controller._documentObj", doc ]], runner);
		runner.builders.object([["app.websheet.model.ModelHelper.editor", app.websheet.Main]], runner);
	};
	
	var unbindDocument = function() {
		var _d = runner.app.websheet.Main.controller._documentObj;
		if (_d && _d.clear) {
			_d.clear();
		}
		runner.builders.object([[ "app.websheet.Main.controller._documentObj", null ]], runner);
		runner.builders.object([["app.websheet.model.ModelHelper.editor", null]], runner);
	};
