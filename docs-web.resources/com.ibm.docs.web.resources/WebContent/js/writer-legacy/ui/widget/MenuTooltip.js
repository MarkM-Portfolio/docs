...
dojo.provide("writer.ui.widget.MenuTooltip");

dojo.require("dijit.Tooltip");
dojo.require("dijit._Widget");
dojo.require("dijit._Templated");
dojo.declare('writer.ui.widget.MenuTooltip', dijit.Tooltip, {
...
//		str = str.replace(/\ /g,"&nbsp;");
	...
	setTitleAck: function(title, ack)
	{
		...
		this.ack = ack;
		var html = "<div>";
		var html = "<span class='tooltipLabel'>" + this.escapeXml(title) + "</span>";
		if(ack)
