dojo.provide("writer.tests.UTcases.message.recive");
...
describe("writer.tests.UTcase.message.recive", function() {
    ...
    it('Insert & Delelte & Replace Key', function() {
        ...
        dojo.forEach(replaceMsgs, function(msg) {
            testRecive(msg);
        });
...
/*
    ...
    it('Add & Reply & Delete Comment', function() {
        ...
        dojo.forEach(insertMsgs, function(msg) {
            testRecive(msg);
        });
        ...
        dojo.forEach(deleteMsgs, function(msg) {
            testRecive(msg);
        });
