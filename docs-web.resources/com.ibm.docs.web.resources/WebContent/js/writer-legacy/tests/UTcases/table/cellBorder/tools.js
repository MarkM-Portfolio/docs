dojo.provide("writer.tests.UTcases.table.cellBorder.tools");
dojo.require("writer.util.CellBorderTools");
dojo.require("writer.util.TableTools");

describe('writer.tests.UTcases.table.cellBorder.tools', function() {
    describe('CellBorderTools', function() {
        var tools = writer.util.CellBorderTools;
    ...
    describe('TableTools', function() {
        ...
        var tools = writer.util.TableTools;
