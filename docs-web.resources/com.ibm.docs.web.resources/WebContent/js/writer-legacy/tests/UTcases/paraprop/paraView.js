dojo.provide("writer.tests.UTcases.paraprop.paraView");

describe("writer.tests.UTcases.paraprop.paraView", function() {
	...
	var loadParaFiveLine = function() {
		...
		var paraModel = new writer.model.Paragraph(json, pe.lotusEditor.document, true);
