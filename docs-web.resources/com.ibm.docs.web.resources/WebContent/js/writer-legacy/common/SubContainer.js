dojo.provide("writer.common.SubContainer");
common.SubContainer = function(container,start,end){
...
//		this.len ++;
	...
	divide:function(obj){
		var s = this.prev(obj);
		if(s){
			var ret = new common.SubContainer(this._container,obj,this._end);
			this._end = s;
			return ret;
