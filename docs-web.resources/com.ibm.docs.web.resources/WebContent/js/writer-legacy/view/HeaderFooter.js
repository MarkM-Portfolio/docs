dojo.provide("writer.view.HeaderFooter");
dojo.require("writer.view.SpaceBlock");
dojo.require("concord.util.BidiUtils");
dojo.declare("writer.view.HeaderFooter",
[writer.view.AbstractView, writer.view.SpaceBlock], {
	...
	*/
	...
	update:function(view){
		...
		if (this._changeDOM && this.domNode){
			writer.view.update.tools.updateDOM(this.getContainer(),this._getContentNode());
	...
	getPages: function(){
		var doc = writer.util.ViewTools.getDocument(this.page);
		return doc.getPages();
	},
	getParent: function(){
		return null;
	...
	_createDOM:function(){
		...
		this.bottomNode = dojo.create("div", {
			"class":  className,
		...
		this.titleTextBottomNode = dojo.create("div", {		
	...
	listener: function(message,param)
	{
		...
		if(message == "editModeChange")
		{
			if (this.domNode)
			{
				...
				dojo.style(this.domNode, { "overflow": isHFEditing ? "visible" : "hidden" });
			}
		}
	}
