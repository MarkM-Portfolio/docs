dojo.provide("writer.view.AnchorView.TBTextBox");
dojo.require("writer.view.AnchorView.AnchorTextBox");

dojo.declare("writer.view.AnchorView.TBTextBox",[writer.view.AnchorView.AnchorTextBox],
		{
			className: "TBTextBox",
...
writer.model.Model.prototype.viewConstructors[writer.MODELTYPE.TBTXBX]=writer.view.AnchorView.TBTextBox;