...
dojo.provide("concord.widgets.concordAutoRotator");
dojo.require("concord.widgets.concordRotator");

(function(d){

	d.declare("concord.widgets.concordAutoRotator", concord.widgets.concordRotator, {
		//	summary:
