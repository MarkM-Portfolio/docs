...
<script type="text/javascript">
	...
	var g_authUser = {'cust_id': '1', 'disp_name': 'test1@cn.ibm.com', 'dn': 'test1@cn.ibm.com', 'email': 'test1@cn.ibm.com', 'id': '1', 'org_id': 'ibm', 'role_id': '0', 'role_name': 'administrator', 'photo_url': '/concord/images/NoPhoto_Person_48.png'};
	var g_authUrl = "/concord/authenticated";
	var g_activitiesUrl = "https://apps.lotuslive.com/activities";
	var g_hbInterval = "30000";
	var g_hbTimeout = "30000";
	var g_hbRetry = "3";
...
{	
	var strContent = "";
	var webClipboard = new concord.beans.WebClipboard();
	//webClipboard.setForceServer(true);
