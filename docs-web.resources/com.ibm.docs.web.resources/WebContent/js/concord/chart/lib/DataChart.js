...
(function(){
	...
	dojo.declare("concord.chart.lib.DataChart", [concord.chart.lib.Chart2D], {
		//	summary:
		//		DataChart
		...
		//	example:
		//
		//	|	var chart = new concord.chart.lib.DataChart("myNode", {
		//	|		displayRange:8,
		//	|		store:dataStore,
		//	|		query:{symbol:"*"},
		//	|		fieldName:"price"
		//	|		type: concord.chart.lib.plot2d.Columns
		//	|	});
		//
		//	properties:
		//
		...
		fieldName: "value",
		//
		//		chartTheme: concord.chart.lib.themes.*
		//			The theme to style the chart. Defaults to PlotKit.blue.
		chartTheme: concord.chart.lib.themes.PlotKit.blue,
		//
		//		displayRange: Number
