dojo.provide("concord.chart.lib.axis2d.Base");

dojo.require("concord.chart.lib.Element");

dojo.declare("concord.chart.lib.axis2d.Base", concord.chart.lib.Element, {
	//	summary:
	//		The base class for any axis.  This is more of an interface/API
	//		definition than anything else; see concord.chart.lib.axis2d.Default
	//		for more details.
	...
	clear: function(){
		...
		//	returns: concord.chart.lib.axis2d.Base
		//		A reference to the axis for functional chaining.
		return this;	//	concord.chart.lib.axis2d.Base
	},
	...
	getScaler: function(){
		...
		//	returns: Object
		//		The scaler object (see concord.chart.lib.scaler.linear for more information)
		return null;	//	Object
	},
	getTicks: function(){
		//	summary:
