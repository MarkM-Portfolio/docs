dojo.provide("concord.chart.lib.plot2d.Grid");
...
/*=====
dojo.declare("concord.chart.lib.plot2d.__GridCtorArgs", concord.chart.lib.plot2d.__DefaultCtorArgs, {
	//	summary:
...
=====*/
(function(){
	var du = dojox.lang.utils, dc = concord.chart.lib.plot2d.common;

	dojo.declare("concord.chart.lib.plot2d.Grid", concord.chart.lib.Element, {
		//	summary:
		...
		constructor: function(chart, kwArgs){
			...
			//	kwArgs: concord.chart.lib.plot2d.__GridCtorArgs?
		...
		clear: function(){
			...
			//	returns: concord.chart.lib.plot2d.Grid
			//		The reference to this plot for functional chaining.
			this._hAxis = null;
			this._vAxis = null;
			this.dirty = true;
			return this;	//	concord.chart.lib.plot2d.Grid
		},
		...
		render: function(dim, offsets){
			...
			try{
				...
				if(ticks && vt && this.opt.hMajorLines){
			...
			try{
				...
				if(ticks && ht && this.opt.vMajorLines){
					dojo.forEach(ticks.major, function(tick){
						var x = offsets.l + ht(tick.value);
