dojo.provide("concord.chart.lib.plot2d.Base");
...
/*=====
concord.chart.lib.plot2d.__PlotCtorArgs = function(){
	//	summary:
...
=====*/
dojo.declare("concord.chart.lib.plot2d.Base", [concord.chart.lib.Element, concord.chart.lib.plot2d._PlotEvents], {
	...
	setAxis: function(axis){
		...
		//	axis: concord.chart.lib.axis2d.Base
		//		The axis to set.
		//	returns: concord.chart.lib.plot2d.Base
		//		A reference to this plot for functional chaining.
		if(axis){
