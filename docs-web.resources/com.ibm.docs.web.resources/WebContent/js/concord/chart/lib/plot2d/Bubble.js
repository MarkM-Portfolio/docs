dojo.provide("concord.chart.lib.plot2d.Bubble");
...
(function(){
	...
	dojo.declare("concord.chart.lib.plot2d.Bubble", concord.chart.lib.plot2d.Base, {
		//	summary:
		...
		render: function(dim, offsets){
			...
			//	returns: concord.chart.lib.plot2d.Bubble
			...
			for(var i = this.series.length - 1; i >= 0; --i){
				...
				if(typeof run.data[0] == "number"){
					console.warn("concord.chart.lib.plot2d.Bubble: the data in the following series cannot be rendered as a bubble chart; ", run);
					continue;
				}
			...
			return this;	//	concord.chart.lib.plot2d.Bubble
		},
