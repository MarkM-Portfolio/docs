dojo.provide("concord.chart.lib.themes.ThreeD");
...
dojo.require("concord.chart.lib.themes.PrimaryColors"); // as a baseline theme

(function(){
	var dc = concord.chart.lib, themes = dc.themes, Theme = dc.Theme,
