dojo.provide("concord.chart.lib.widget.SelectableLegend");

dojo.require("concord.chart.lib.widget.Legend");
...
(function(){
	...
	dojo.declare("concord.chart.lib.widget.SelectableLegend", [concord.chart.lib.widget.Legend], {
		//	summary:
		...
		refresh: function(){
			...
			this.inherited(arguments);
			this._applyEvents();
			new concord.chart.lib.widget._FocusManager(this);
		},
		...
		_getAnim: function(plotName){
			if(!this.legendAnim[plotName]){
				this.legendAnim[plotName] = new concord.chart.lib.action2d.Highlight(this.chart, plotName);
			}
		...
		_getTransitionFill: function(plotName){
			...
			if(this.chart.stack[this.chart.plots[plotName]].declaredClass.indexOf("concord.chart.lib.plot2d.Stacked") != -1){
		...
		_isPie: function(){
			return this.chart.stack[0].declaredClass == "concord.chart.lib.plot2d.Pie";
		}
	});
	...
	dojo.declare("concord.chart.lib.widget._FocusManager", null, {
		//	summary:
