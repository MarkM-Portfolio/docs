dojo.provide("concord.chart.lib.StoreSeries");

dojo.declare("concord.chart.lib.StoreSeries", null, {
	...
	setSeriesObject: function(series){
		//	summary:
		//		Sets a concord.chart.lib.Series object we will be working with.
