dojo.provide("concord.chart.lib.action2d.Highlight");

dojo.require("concord.chart.lib.action2d.Base");
dojo.require("dojox.color");

/*=====
dojo.declare("concord.chart.lib.action2d.__HighlightCtorArgs", concord.chart.lib.action2d.__BaseCtorArgs, {
	//	summary:
...
(function(){
	...
	dojo.declare("concord.chart.lib.action2d.Highlight", concord.chart.lib.action2d.Base, {
		//	summary:
		...
		constructor: function(chart, plot, kwArgs){
			...
			//	kwArgs: concord.chart.lib.action2d.__HighlightCtorArgs?
