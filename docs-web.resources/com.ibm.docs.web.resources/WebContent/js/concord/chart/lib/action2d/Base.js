dojo.provide("concord.chart.lib.action2d.Base");
...
/*=====
concord.chart.lib.action2d.__BaseCtorArgs = function(duration, easing){
 	//	summary:
...
(function(){
	...
	dojo.declare("concord.chart.lib.action2d.Base", null, {
		...
		constructor: function(chart, plot, kwargs){
			...
			//	kwargs: concord.chart.lib.action2d.__BaseCtorArgs?
