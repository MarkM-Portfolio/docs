dojo.provide("concord.chart.lib.action2d.Magnify");
...
/*=====
dojo.declare("concord.chart.lib.action2d.__MagnifyCtorArgs", concord.chart.lib.action2d.__BaseCtorArgs, {
	//	summary:
...
(function(){
	...
	dojo.declare("concord.chart.lib.action2d.Magnify", concord.chart.lib.action2d.Base, {
		//	summary:
		...
		constructor: function(chart, plot, kwArgs){
			...
			//	kwArgs: concord.chart.lib.action2d.__MagnifyCtorArgs?
