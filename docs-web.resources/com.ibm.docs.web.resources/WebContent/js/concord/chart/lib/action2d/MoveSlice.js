dojo.provide("concord.chart.lib.action2d.MoveSlice");
...
/*=====
dojo.declare("concord.chart.lib.action2d.__MoveSliceCtorArgs", concord.chart.lib.action2d.__BaseCtorArgs, {
	//	summary:
...
(function(){
	...
	dojo.declare("concord.chart.lib.action2d.MoveSlice", concord.chart.lib.action2d.Base, {
		//	summary:
		...
		constructor: function(chart, plot, kwArgs){
			...
			//	kwArgs: concord.chart.lib.action2d.__MoveSliceCtorArgs?
