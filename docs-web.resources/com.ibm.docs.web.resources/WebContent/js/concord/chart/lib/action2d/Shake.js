dojo.provide("concord.chart.lib.action2d.Shake");
...
/*=====
dojo.declare("concord.chart.lib.action2d.__ShakeCtorArgs", concord.chart.lib.action2d.__BaseCtorArgs, {
	//	summary:
...
(function(){
	...
	dojo.declare("concord.chart.lib.action2d.Shake", concord.chart.lib.action2d.Base, {
		//	summary:
		...
		constructor: function(chart, plot, kwArgs){
			...
			//	kwArgs: concord.chart.lib.action2d.__ShakeCtorArgs?
