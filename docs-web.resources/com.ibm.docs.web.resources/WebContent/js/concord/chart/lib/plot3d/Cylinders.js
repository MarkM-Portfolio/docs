dojo.provide("concord.chart.lib.plot3d.Cylinders");

dojo.require("concord.chart.lib.plot3d.Base");
...
(function(){
	...
	dojo.declare("concord.chart.lib.plot3d.Cylinders", concord.chart.lib.plot3d.Base, {
