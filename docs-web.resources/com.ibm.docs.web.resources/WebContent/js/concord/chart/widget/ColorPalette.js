...
dojo.provide("concord.chart.widget.ColorPalette");
dojo.require("dijit._Widget");
dojo.require("dijit._Templated");
dojo.require("dojo.colors");
dojo.require("dojo.i18n");
dojo.requireLocalization("dojo", "colors");
dojo.declare("concord.chart.widget.ColorPalette",
	...
	templateString: dojo.cache("concord.chart.widget", "templates/ColorPalette.html"),
	
	// _paletteDims: [protected] Object
	//		Size of the supported palettes for alignment purposes.
	_paletteDims: {"width":"194px", "height": "120px", "padding":"8px"},
	tabIndex: "0",
	buildRendering: function(){
		...
		dijit.setWaiState(this.divNode, "label", "color");
	...
	//	this.domNode.style.padding = "8px";
		...
		for(var row=0; row < choices.length; row++){
			...
			for(var col=0; col < choices[row].length; col++){
				...
				var name = this.colorNames[color] || "Auto";
