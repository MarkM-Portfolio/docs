...
/*                                                                   */
/* ***************************************************************** */
dojo.provide("viewer.widgets.DocPageIndicator");
...
dojo.declare(
	"viewer.widgets.DocPageIndicator",
	[viewer.widgets.PageControlWidget, dijit._Widget, dijit._Templated],
	{
		...
		postCreate: function(){
			...
			dojo.subscribe(writer.constants.EVENT.SCROLLPAGE, this, this._onPageInfoUpdated);
			this.inherited(arguments);
		},
		
		_onPageInfoUpdated: function(curPageNum, totalPageNum){
			this.setCurrentPage(curPageNum);
