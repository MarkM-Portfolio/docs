...
define([
...
], function(declare, lang, Container, constants, Image, TextBox, ModelTools, trackChange) {
     ...
     *****************************************************
     */
    var Canvas = declare("writer.model.text.Canvas", Image, {
        modelType: constants.MODELTYPE.CANVAS,
        WRAP: {
            //before text or after text
            wrapNone: constants.MODELTYPE.FLCANVAS,
            wrapSquare: constants.MODELTYPE.SQCANVAS,
            wrapTopAndBottom: constants.MODELTYPE.TBCANVAS
        },
        bodyPr: null,
        delayUpdate: true,
        ...
        constructor: function(json, owner, simpleStruct) {
            if (simpleStruct)
                this.modelType = constants.MODELTYPE.SIMPLECANVAS;

            this._children = new Container(this);
            ...
            wpx.wgp && this._createChildren(wpx.wgp, Canvas);
            wpx.grpSp && this._createChildren(wpx.grpSp, Canvas);
            wpx.txbx && this._createChildren(wpx.txbx, TextBox);
            wpx.pic && this._createChildren(wpx.pic, Image);
        ...
        _sortChildrenByZ: function() {
            var comp = function(child1, child2) {
                return child1.relativeHeight - child2.relativeHeight;
            };
