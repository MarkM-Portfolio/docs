...
], function(declare, htmlParser, JsonWriter, msgHelper) {

    var paragraph = declare("writer.filter.htmlParser.paragraph", JsonWriter, {
        ...
        toJson: function() {
            ...
            //get formats
            var index = 0,
                text, i, children = element.children;
            ...
            for (i = 0; i < children.length; i++) { //add children fmts
                ...
                if (text.length) {
                    ...
                    if (children[i].name == "br") {
                        if (children.length == 1) { //only one br in paragraph.
                            retVal.fmt.push({
                                "rt": "rPr",
                                "s": 0,
                                "l": 0,
