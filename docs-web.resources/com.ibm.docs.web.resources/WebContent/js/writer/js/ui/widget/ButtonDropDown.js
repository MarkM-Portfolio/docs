...
define([
    ...
    "dojo/_base/lang",
    "dojo/dom-class",
    "dojo/text!writer/templates/ButtonDropDown.html",
    "dijit/form/Button",
    "dijit/_Container",
    "writer/ui/widget/_HasDropDown",
    "dijit/popup"
], function(declare, langModule, domClass, template, Button, _Container, _HasDropDown, popupUtils) {

    var ButtonDropDown = declare("writer.ui.widget.ButtonDropDown", [Button, _Container, _HasDropDown], {
        // summary:
        ...
        postCreate: function() {
            ...
            this.iconNode.onmouseover = function(e) {
                var t = e.target;
                t && domClass.add(t, 'buttonDropiconButtonHover');
            };
            this.iconNode.onmouseout = function(e) {
                var t = e.target;
                t && domClass.remove(t, 'buttonDropiconButtonHover');
            };
            ...
            this._buttonNode.onmouseover = function(e) {
                var t = e.target;
                t && domClass.add(t, 'iconButton');
            };
            this._buttonNode.onmouseout = function(e) {
                var t = e.target;
                t && domClass.remove(t, 'iconButton');
            };
        },
        toggleDropDown: function() {
            ...
            if (!this._opened) {
                ...
                if (!this.isLoaded()) {
                    this.loadDropDown(langModule.hitch(this, "openDropDown"));
                    return;
                } else {
                    this.openDropDown();
                }
