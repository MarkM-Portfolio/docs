...
], function(declare, Plugin, ViewTools, i18nmenubar) {

    var Image = declare("writer.plugins.Image", Plugin, {
        init: function() {
                ...
                ctx.addListener(function(target, selection) {
                    ...
                    ret.WrapText = {
                        ...
                        getSubItems: function() {
                            return {
                                ImgInline: {
                                    disabled: viewType == "text.ImageView"
                                },
                                ImgSquare: {
                                    disabled: viewType == "text.SquareImage"
                                },
                                ImgTopBottom: {
                                    disabled: viewType == "text.TBImage"
                                },
                                ImgBehind: {
                                    disabled: viewType == "text.FloatImage" && behindDoc
                                },
                                ImgInFront: {
                                    disabled: viewType == "text.FloatImage" && !behindDoc
                                },
                                ImgMoreWrap: {
                                    ...
                                    getSubItems: function() {
                                        return {
                                            BothSides: {
                                                disabled: wrapText == "bothSides"
                                            },
                                            LeftOnly: {
                                                disabled: wrapText == "left"
                                            },
                                            RightOnly: {
                                                disabled: wrapText == "right"
                                            },
                                            LargestOnly: {
                                                disabled: wrapText == "largest"
                                            }
                                        };
                                    }
                                }
                    ...
                    var setCState = function(items) {
                        for (var id in items) {
                            ...
                            if (cmd)
                                cmd.state = item.disabled ? constants.CMDSTATE.TRISTATE_DISABLED : constants.CMDSTATE.TRISTATE_ON;
