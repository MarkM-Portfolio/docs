...
define([
...
], function(declare, domConstruct, tools, constants, Model, AbstractCanvas, AnchorImageView) {
    ...
    var SimpleCanvas = declare("writer.view.AnchorView.SimpleCanvas", [AnchorImageView, AbstractCanvas], {
        ...
        ifPointMe: function(x, y) {
            ret = x >= this.left && x <= this.left + this.w && y >= this.top && y <= this.top + this.h;
    ...
    Model.prototype.viewConstructors[constants.MODELTYPE.SIMPLECANVAS] = SimpleCanvas;
