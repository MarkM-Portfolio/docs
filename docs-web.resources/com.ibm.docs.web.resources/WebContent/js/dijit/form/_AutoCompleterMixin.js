define([
	...
	var AutoCompleterMixin = declare("dijit.form._AutoCompleterMixin", SearchMixin, {
		...
		doHighlight: function(/*String*/ label, /*String*/ find){
			...
			//Do not use unicode uFFFF directly in string, or else on IE after compress it become invalid.(defect 41588)
			return this._escapeHtml(label.replace(
				new RegExp((i == 0 ? "^" : "") + "(" + find + ")" + (i == (this.queryExpr.length - 4) ? "$" : ""), modifiers),
				String.fromCharCode(65535)+'$1'+String.fromCharCode(65535))).replace(
