...
dojo.provide("pres.widget.common.TablePalette");

dojo.declare("pres.widget.common.TablePalette", [dijit._Widget, dijit._Templated], {
	templateString: dojo.cache("pres", "templates/TablePalette.html"),
	...
	bindEvent: function()
	{
		dojo.connect(this.containerNode, "onmousedown", this, "_createTable");
	...
	{
		if(!this.nls)
			this.nls = dojo.i18n.getLocalization("pres", "pres");
		...
		if(bAnnounce){
			...
			pe.scene.slideEditor && pe.scene.slideEditor.announce(accStr);
		}
	},
	...
	{
		dojo.style(this.highlightedNode, {
