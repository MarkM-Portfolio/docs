({
	...
	mergeCellConfirm: "Merging these cells hides the contents of the cells. Are you sure that you want to merge the selected cells?",
	...
	maxImgSize: "The image is too large to upload. The Maxinum size of a image that can be upload is ${0} KB.",
	...
	FW_CANNOT_MERGECELL: "Cannot freeze panes across merged cells.",
