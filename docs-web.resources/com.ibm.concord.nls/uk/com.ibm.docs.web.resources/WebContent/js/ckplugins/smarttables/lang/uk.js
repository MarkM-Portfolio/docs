...
CKEDITOR.plugins.setLang( "smarttables", "en",{
	smarttables :
	{
	   ...
	   toolbarAddSTRowAbv: "Add Row Above",
	   toolbarAddSTRowBlw: "Add Row Below",
	   toolbarAddSTColBfr: "Add Column Before",
	   toolbarAddSTColAft: "Add Column After",   
	   toolbarDelSTRow: "Delete Row",
	   toolbarDelSTCol: "Delete Column",
	   toolbarDelST: "Delete Table",
	   toolbarChgSTStyle: "Change Table Style",
	   toolbarMoveSTRowUp: "Move Row Up",
	   toolbarMoveSTRowDown: "Move Row Down",
	   ...
	   toolbarAlignTextLeft: "Align Text Left",
	   toolbarAlignTextCenter: "Align Text Center",
	   toolbarAlignTextRight: "Align Text Right",
	   toolbarClearSTCellContent: "Clear Content",
	   ...
	   ctxMenuSTRow: "Row",
	   ctxMenuAddSTRowAbv: "Add Row Above",
	   ctxMenuAddSTRowBlw: "Add Row Below",
	   ctxMenuMoveSTRowUp: "Move Row Above",
	   ctxMenuMoveSTRowDown: "Move Row Below",
	   ctxMenuDelSTRow: "Delete",
	   ctxMenuSTCol: "Column",
	   ctxMenuAddSTColBfr: "Add Column Before",
	   ctxMenuAddSTColAft: "Add Column After",  
	   ...
	   ctxMenuSTCell: "Cell",
	   ctxMenuAlignTextLeft: "Align Text Left",
	   ctxMenuAlignTextCenter: "Align Text Center",
	   ctxMenuAlignTextRight: "Align Text Right",
	   ...
	   ctxMenuAddSummary: "Add table summary",
	   ctxMenuAddCaption: "Add table description",
	   ...
	   dlgMsgValidationRowsMax:"The maximum number of rows is 200",
	   dlgMsgValidationColsMax:"The maximum number of columns value is 25",
	   dlgMsgValidationRows:"The value must be a number",
	   dlgMsgValidationCols:"The value must be a number"
	}
});
