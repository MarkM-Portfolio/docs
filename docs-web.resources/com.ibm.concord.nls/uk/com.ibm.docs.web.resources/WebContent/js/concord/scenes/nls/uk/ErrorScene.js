...
({
	...
	doc_toolarge_content3: "The file cannot be accessed, because the size of the file is greater than ${0} KB.",
	...
	pres_toolarge_content3_mobile: "The presentation cannot be opened, because it contains more than ${0} graphics on a mobile device.",
	...
	encrypted_pptdoc_title:"The encrypted document is not supported.",
	encrypted_pptdoc_content:"This file is password-protected. To open the file in ${productName}, first make sure that the file is decrypted.",
	...
	encrypted_conversion_error_title:"The encrypted document is not supported.",
