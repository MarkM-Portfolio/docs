...
({
	   toolbarAddST: "添加表格",
	   toolbarAddSTRowAbv: "在上方添加行",
	   toolbarAddSTRowBlw: "在下方添加行",
	   toolbarAddSTColBfr: "在之前添加列",
	   toolbarAddSTColAft: "在之后添加列",   
	   toolbarDelSTRow: "删除行",
	   toolbarDelSTCol: "删除列",
	   toolbarDelST: "删除表格",
	   ...
	   toolbarAlignTextLeft: "向左对齐文本",
	   toolbarAlignTextCenter: "文本居中对齐",
	   toolbarAlignTextRight: "向右对齐文本",
	   toolbarClearSTCellContent: "清除内容",
	   ...
	   ctxMenuSTRow: "行",
	   ctxMenuAddSTRowAbv: "在上方添加行",
	   ctxMenuAddSTRowBlw: "在下方添加行",
	   ctxMenuMoveSTRowUp: "将行上移",
	   ctxMenuMoveSTRowDown: "将行下移",
	   ctxMenuDelSTRow: "删除",
	   ctxMenuSTCol: "列",
	   ctxMenuAddSTColBfr: "在之前添加列",
	   ctxMenuAddSTColAft: "在之后添加列",  
	   ...
	   ctxMenuSTCell: "单元格",
	   ctxMenuAlignTextLeft: "向左对齐文本",
	   ctxMenuAlignTextCenter: "文本居中对齐",
	   ctxMenuAlignTextRight: "向右对齐文本",
	   ...
	   dlgMsgValidationRows:"该值必须是数字",
	   dlgMsgValidationCols:"该值必须是数字",
