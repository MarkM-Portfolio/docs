...
CKEDITOR.plugins.setLang( 'specialchar', 'ko',
{
	...
	sup1: "윗첨자 1",
	ordm: "남성 표시기",
	raquo: "오른쪽을 가리키는 이중 각도 물음표",
	frac14: "분수 1/4",
	frac12: "분수 1/2",
	frac34: "분수 3/4",
	iquest: "역 물음표",
	Agrave: "억음 액센트 부호가 있는 라틴어 대문자 A",
	Aacute: "양음 액센트 부호가 있는 라틴어 대문자 A",
	Acirc: "곡절 부호가 있는 라틴어 대문자 A",
	Atilde: "물결 기호가 있는 라틴어 대문자 A",
	Auml: "분음 부호가 있는 라틴어 대문자 A",
	Aring: "위쪽에 동그라미가 있는 라틴어 대문자 A",
	AElig: "라틴어 대문자 Æ",
	...
	ccedil: "세디유가 있는 라틴어 소문자 c",
	egrave: "억음 액센트 부호가 있는 라틴어 소문자 e",
	eacute: "양음 액센트 부호가 있는 라틴어 소문자 e",
	ecirc: "곡절 부호가 있는 라틴어 소문자 e",
	euml: "분음 부호가 있는 라틴어 소문자 e",
	igrave: "억음 액센트 부호가 있는 라틴어 소문자 i",
	iacute: "양음 액센트 부호가 있는 라틴어 소문자 i",
	icirc: "곡절 부호가 있는 라틴어 소문자 i",
	iuml: "분음 부호가 있는 라틴어 소문자 i",
	eth: "라틴어 소문자 eth",
	ntilde: "물결 기호가 있는 라틴어 소문자 n",
	ograve: "억음 액센트 부호가 있는 라틴어 소문자 o",
	oacute: "양음 액센트 부호가 있는 라틴어 소문자 o",
	ocirc: "곡절 부호가 있는 라틴어 소문자 o",
	otilde: "물결 기호가 있는 라틴어 소문자 o",
	ouml: "분음 부호가 있는 라틴어 소문자 o",
	divide: "나누기 부호",
	oslash: "선이 있는 라틴어 소문자 o",
	ugrave: "억음 액센트 부호가 있는 라틴어 소문자 u",
	uacute: "양음 액센트 부호가 있는 라틴어 소문자 u",
	ucirc: "곡절 부호가 있는 라틴어 소문자 u",
	uuml: "분음 부호가 있는 라틴어 소문자 u",
	yacute: "양음 액센트 부호가 있는 라틴어 소문자 y",
	thorn: "라틴어 소문자 thorn",
	yuml: "분음 부호가 있는 라틴어 소문자 y",
	OElig: "라틴어 대문자 합자 OE",
	oelig: "라틴어 소문자 합자 oe",
	'372': "곡절 부호가 있는 라틴어 대문자 W",
	'374': "곡절 부호가 있는 라틴어 대문자 Y",
	'373': "곡절 부호가 있는 라틴어 소문자 w",
	'375': "곡절 부호가 있는 라틴어 소문자 y",
	sbquo: "low-9 작은따옴표",
	'8219': "high-reversed-9 따옴표",
	bdquo: "low-9 큰따옴표",
	hellip: "가로 생략 부호",
	trade: "상표 부호",
	'9658': "오른쪽을 가리키는 검은색 포인터",
	bull: "글머리 기호",
	rarr: "오른쪽 화살표",
	rArr: "오른쪽 이중 화살표",
	hArr: "왼쪽 이중 화살표",
