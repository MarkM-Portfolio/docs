...
({
	   ...
	   toolbarAddSTRowAbv: "Ajouter une ligne au-dessus",
	   toolbarAddSTRowBlw: "Ajouter une ligne au-dessous",
	   toolbarAddSTColBfr: "Ajouter une colonne avant",
	   toolbarAddSTColAft: "Ajouter une colonne après",   
	   ...
	   toolbarMoveSTRowUp: "Déplacer la ligne vers le haut",
	   toolbarMoveSTRowDown: "Déplacer la ligne vers le bas",
	   toolbarMoveSTColBefore: "Déplacer la colonne à gauche",
	   toolbarMoveSTColAfter: "Déplacer la colonne à droite",
	   toolbarSortSTColAsc: "Tri croissant",
	   toolbarSortSTColDesc: "Tri décroissant",
	   toolbarResizeSTCols: "Redimensionner les colonnes",
	   toolbarAlignTextLeft: "Aligner le texte à gauche",
	   toolbarAlignTextCenter: "Centrer le texte",
	   toolbarAlignTextRight: "Aligner le texte à droite",
	   toolbarClearSTCellContent: "Effacer le contenu",
	   ...
	   ctxMenuSTRow: "Ligne",
	   ctxMenuAddSTRowAbv: "Ajouter une ligne au-dessus",
	   ctxMenuAddSTRowBlw: "Ajouter une ligne au-dessous",
	   ...
	   ctxMenuAddSTColBfr: "Ajouter une colonne avant",
	   ctxMenuAddSTColAft: "Ajouter une colonne après",  
	   ctxMenuMoveSTColBefore: "Déplacer la colonne à gauche",
	   ctxMenuMoveSTColAfter: "Déplacer la colonne à droite",
	   ...
	   ctxMenuAlignTextLeft: "Aligner le texte à gauche",
	   ctxMenuAlignTextCenter: "Centrer le texte",
	   ctxMenuAlignTextRight: "Aligner le texte à droite",
	   ...
	   dlgTitleAddST: "Créer un tableau",
	   ...
	   dlgMsgValidationRows:"La valeur doit être un nombre",
	   dlgMsgValidationCols:"La valeur doit être un nombre",
