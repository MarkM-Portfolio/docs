...
({
	   ...
	   toolbarAddSTRowAbv: "Añadir fila arriba",
	   toolbarAddSTRowBlw: "Añadir fila abajo",
	   toolbarAddSTColBfr: "Añadir columna antes",
	   toolbarAddSTColAft: "Añadir columna después",   
	   toolbarDelSTRow: "Eliminar fila",
	   toolbarDelSTCol: "Eliminar columna",
	   toolbarDelST: "Suprimir tabla",
	   toolbarChgSTStyle: "Cambiar estilo de tabla",
	   toolbarMoveSTRowUp: "Subir fila",
	   toolbarMoveSTRowDown: "Bajar fila",
	   ...
	   toolbarAlignTextLeft: "Alinear texto a la izquierda",
	   toolbarAlignTextCenter: "Alinear texto al centro",
	   toolbarAlignTextRight: "Alinear texto a la derecha",
	   toolbarClearSTCellContent: "Borrar contenido",
	   ...
	   ctxMenuSTRow: "Fila",
	   ctxMenuAddSTRowAbv: "Añadir fila arriba",
	   ctxMenuAddSTRowBlw: "Añadir fila abajo",
	   ctxMenuMoveSTRowUp: "Mover fila arriba",
	   ctxMenuMoveSTRowDown: "Mover fila abajo",
	   ctxMenuDelSTRow: "Suprimir",
	   ctxMenuSTCol: "Columna",
	   ctxMenuAddSTColBfr: "Añadir columna antes",
	   ctxMenuAddSTColAft: "Añadir columna después",  
	   ...
	   ctxMenuSTCell: "Celda",
	   ctxMenuAlignTextLeft: "Alinear texto a la izquierda",
	   ctxMenuAlignTextCenter: "Alinear texto al centro",
	   ctxMenuAlignTextRight: "Alinear texto a la derecha",
	   ...
	   dlgMsgValidationRows:"El valor debe ser un número",
	   dlgMsgValidationCols:"El valor debe ser un número",
