...
({
	   ...
	   toolbarAddSTRowAbv: "Добавить строку сверху",
	   toolbarAddSTRowBlw: "Добавить строку снизу",
	   toolbarAddSTColBfr: "Добавить столбец перед",
	   toolbarAddSTColAft: "Добавить столбец после",   
	   ...
	   toolbarMoveSTRowUp: "Переместить строку выше",
	   toolbarMoveSTRowDown: "Переместить строку ниже",
	   ...
	   toolbarAlignTextLeft: "Выровнять текст по левому краю",
	   toolbarAlignTextCenter: "Выровнять текст по центру",
	   toolbarAlignTextRight: "Выровнять текст по правому краю",
	   toolbarClearSTCellContent: "Удалить содержимое",
	   ...
	   ctxMenuSTRow: "Строка",
	   ctxMenuAddSTRowAbv: "Добавить строку сверху",
	   ctxMenuAddSTRowBlw: "Добавить строку снизу",
	   ...
	   ctxMenuAddSTColBfr: "Добавить столбец перед",
	   ctxMenuAddSTColAft: "Добавить столбец после",  
	   ...
	   ctxMenuAlignTextLeft: "Выровнять текст по левому краю",
	   ctxMenuAlignTextCenter: "Выровнять текст по центру",
	   ctxMenuAlignTextRight: "Выровнять текст по правому краю",
	   ...
	   dlgMsgValidationRows:"Значением должно быть число",
	   dlgMsgValidationCols:"Значением должно быть число",
