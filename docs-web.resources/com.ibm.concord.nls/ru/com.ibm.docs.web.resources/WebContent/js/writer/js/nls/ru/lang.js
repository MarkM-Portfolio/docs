...
/* ***************************************************************** */
define({
        PAGE_BREAK_TEXT: "Разрыв страницы",
        SECTION_BREAK_TEXT: "Разрыв раздела",
        LINE_BREAK_TEXT: "Перевод строки",
        COLUMN_BREAK_TEXT: "Разрыв столбца",
        INSERT_IMAGE_NOT_PROPER_PLACE: "Изображения можно добавлять только в текст тела или таблицы. В текущее место добавлять изображения нельзя.",
