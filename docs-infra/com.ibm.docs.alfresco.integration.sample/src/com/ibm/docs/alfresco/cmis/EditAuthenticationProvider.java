...
public class EditAuthenticationProvider extends StandardAuthenticationProvider
{  
  private static final long serialVersionUID = -6722638916677194923L;
  ...
  {   
    String ticket = null;
    Cookie[] cookies = URLConfig.getRequestCookies(); // Include com.ibm.docs.common.jar in build path
