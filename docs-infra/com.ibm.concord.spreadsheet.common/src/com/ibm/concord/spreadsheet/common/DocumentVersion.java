...
public enum DocumentVersion {
  ...
  VERSION_1_0_2("1.02"),
  /*
   * Version that uses more abbr. JSON keys
   */
  VERSION_1_0_3("1.03"),
  /*
  ...
  VERSION_1_0_4("1.04"),
  /*
   * support Conditional Formatting in OOXML format
   */
  VERSION_1_0_5("1.05"),
  /*
   * support View of Shape in OOXML format
   */  
  VERSION_1_0_6("1.06");
    ...
    switch (feature)
      {
        ...
        case MORE_ABBR_NAME :
          return this != BEFORE_1_0_0 && this != VERSION_1_0_0 && this != VERSION_1_0_1 && this != VERSION_1_0_2;
        case SHAPE_WITHOUT_TXT:
          return this == VERSION_1_0_6;
        default:
          return false;
      }
  }
