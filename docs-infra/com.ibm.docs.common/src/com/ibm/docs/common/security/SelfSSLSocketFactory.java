...
public class SelfSSLSocketFactory extends SSLProtocolSocketFactory
{
  ...
  public static SSLContext createEasySSLContext()
  {
    try
    {
      String sslProtocol = WASConfigHelper.getSSLProtocol();
      ...
      LOG.info("Docs SSL context will use protocol " + sslProtocol);
