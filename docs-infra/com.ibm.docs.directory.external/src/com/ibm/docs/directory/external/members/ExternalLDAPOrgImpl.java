...
public class ExternalLDAPOrgImpl implements IOrg
{
  ...
  public ExternalLDAPOrgImpl(ExternalLDAPMembersModel model, String id, Map<String, String> properties)
  {
    this.model = model;
    this.id = id;
  ...
  public IUser getUser(String userId)
  {
    ...
    ExternalLDAPUserImpl user = null;
    try
    {
    ...
    if (dsUser != null)
    {
      user = new ExternalLDAPUserImpl(this.model, dsUser);
    }
  ...
  public List<IUser> getUsersByPropertyExactMatch(UserProperty prop, String value)
  {
    if (UserProperty.PROP_EMAIL.toString().equals(prop))
    {
      ...
      if (dsUser != null)
      {
        ExternalLDAPUserImpl user = new ExternalLDAPUserImpl(this.model, dsUser);
