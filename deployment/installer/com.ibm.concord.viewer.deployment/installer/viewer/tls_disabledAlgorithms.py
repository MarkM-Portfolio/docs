...
VIEWER_PROPERTIES_PATH = "profiles/AppSrv1/properties/"
...
def restrictCiphers():
    ...
    for line in fileinput.input(root + VIEWER_PROPERTIES_PATH + PROFILE_SSL_CLIENT_PROPS, backup='.bak', inplace=1):  
