...
def showhelp():
  print "usage:"
  print "for example: ------------------------------------"
  print "wsadmin.bat/sh -lang jython -username xx -password xx -f domain_list_mgr.py -action add -domain value "
  print "wsadmin.bat/sh -lang jython -username xx -password xx -f domain_list_mgr.py -action delete -domain value "
  sys.exit(2)
...
def doAction(func, args):
  try:
    mbean=AdminControl.queryNames("com.ibm.concord.platform.mbean:type=DomainListMrg,*")
