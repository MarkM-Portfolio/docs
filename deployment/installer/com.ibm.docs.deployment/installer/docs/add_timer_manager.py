...
TIMER_MANAGER_NAME = 'DocsTimerManager'
TIMER_MANAGER_JNDI_NAME = 'com/ibm/docs/housekeeping/timermanager'
...
class AddTimerManager(command.Command):  
  ...
  def do(self):
    log.info("Start to create TimerManager for Docs Server")
    ...
    log.info("Create TimerManager for Docs Server completed")
    return True

  def undo(self):
    log.info("Start to delete TimerManager for Docs Server")
    ...
    log.info("Delete TimerManager for Docs Server completed")
    return True
