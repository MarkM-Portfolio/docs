...
#A1,A2,A3,A4,B1,B2,A1,A4,A5,A2
ut_commands_01 = [
  {
    'class': 'ut.Checkpoint',
    'isEnabled': False,
    'expected': 'A1A2A3A4B1B2A1A4A5A2',
    'actual': ''
  },
...
#A1,A2,A3,A4,C1,C2,C3,A1,A4,A5,A2
ut_commands_02 = [
  {
    'class': 'ut.Checkpoint',
    'isEnabled': False,
    'expected': 'A1A2A3A4C1C2C3A1A4A5A2',
    'actual': ''
  },
...
#A1,A2,A3,A4,D1,D2,D3,D4,D1,D4,A1,A4,A5,A2
ut_commands_03 = [
  {
    'class': 'ut.Checkpoint',
    'isEnabled': False,
    'expected': 'A1A2A3A4D1D2D3D4D1D4A1A4A5A2',
    'actual': ''
  },
...
#A1,A2,A3,A4,F1,A1,A4,A5,A2
ut_commands_05 = [
  {
    'class': 'ut.Checkpoint',
    'isEnabled': False,
    'expected': 'A1A2A3A4F1A1A4A5A2',
    'actual': ''
  },
...
#A1,A2,A3,A4,G1,G2,A1,A4,A5,A2
ut_commands_06 = [
  {
    'class': 'ut.Checkpoint',
    'isEnabled': False,
    'expected': 'A1A2A3A4G1G2A1A4A5A2',
    'actual': ''
  },
...
#A1,A2,A3,A4,H1,H2,H3,A1,A4,A5,A2
ut_commands_07 = [
  {
    'class': 'ut.Checkpoint',
    'isEnabled': False,
    'expected': 'A1A2A3A4H1H2H3A1A4A5A2',
    'actual': ''
  },
...
#A1,A2,A3,A4,I1,I2,I3,I4,I1,I4,A1,A4,A5,A2
ut_commands_08 = [
  {
    'class': 'ut.Checkpoint',
    'isEnabled': False,
    'expected': 'A1A2A3A4I1I2I3I4I1I4A1A4A5A2',
    'actual': ''
  },
