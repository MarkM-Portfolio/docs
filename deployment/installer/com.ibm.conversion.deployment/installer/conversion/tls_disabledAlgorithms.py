...
CONVERSION_PROPERTIES_PATH = "profiles/AppSrv2/properties/"
...
def restrictCiphers():
    ...
    root = WAS_INSTALL_ROOT
    if sys.platform == 'win32':
        root = r'/Program Files/IBM/WebSphere/AppServer/'
            
    for line in fileinput.input(root + CONVERSION_PROPERTIES_PATH + PROFILE_SSL_CLIENT_PROPS, backup='.bak', inplace=1):  
...
if __name__ == '__main__' :
    ...
    """
    if len(sys.argv) < 2:
        print(">>> Errors for arguments number passed to tls_disabledAlgorithms")
        sys.exit()
    ...
    print('Successfully created custom security property:  com.ibm.websphere.tls.disabledAlgorithms=SSLv3, RC4, MD5withRSA, DH keySize < 1024 ...')
