...
schtasks.exe /create /F /TN "kill_timeout" /RL HIGHEST /SC MINUTE /MO 5 /TR "$powershell -executionpolicy RemoteSigned $IBMConversions/sym_monitor/kill_timeout.ps1 $IBMConversions/repo 1000 120"
