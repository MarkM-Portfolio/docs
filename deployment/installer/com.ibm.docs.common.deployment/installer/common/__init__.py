...
if not sys.platform.lower().startswith('java'):
  ...
  def init_essential(properties_section, install_root_key, caller_filename):
    ...
    print (os.path.join(logs_dir, log_file))
  ...
  if version_info['product_name'] == 'IBM Conversion' or version_info['product_name'] == 'HCL Conversion':
    ...
    from common.utils.log import conversion_config_log as config_log
    ...
    from common.utils.log import concord_config_log as config_log
    ...
    from common.utils.log import docs_daemon_config_log as config_log
  ...
  # names exported from common package
  from common.commands import command
  from common.commands.show_license import ShowLicense
  from common.utils.files import call_wsadmin, ZipCompat, FileInstall, check_version, get_upgrade_type, parse_ws_map, split_lines, backup_file
  from common.utils import was_cmd_util, configfiles
  from common.utils.log import was_log
  from common.utils import common_dict
  from common.utils.hunging_check import HungingCheck
  from common.utils.promoting_check import PromotingCheck
  from common.utils import check_tasks
  from common.utils import precheck_factory
  from common.utils import was_cmd_util
  from common.utils import was
