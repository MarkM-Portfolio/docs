...
class ConfigChangeLog:
  ...
  def log_existed_config(self, key, current_value, recommend_value, config_path, console_log):
    log_file = open(self.log_path, 'a')
    content = []
...
viewer_daemon_config_log = ConfigChangeLog('viewer_daemon_upgrade.log')