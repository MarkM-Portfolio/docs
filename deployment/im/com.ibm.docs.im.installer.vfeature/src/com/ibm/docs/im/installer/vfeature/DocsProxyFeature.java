 ...
 *
 */
public class DocsProxyFeature implements ISelectionExpression
{
  @Override
  public IStatus evaluate(EvaluationContext arg0)
  {
    ...
    if (arg0!=null && arg0 instanceof IAdaptable)
    {
      ...
      {        
        ...
        //Docs Proxy
        String cfgFileDir = (new StringBuffer()).append(installationRoot).append(File.separator).append(Constants.DOCS_PROXY_LOCAL_DIR).append(File.separator).append(Constants.DOCS_PROXY_SUB_DIR).append(File.separator).append(Constants.CONFIG_PROPERTIES_FILE).toString();
        ...
        {
          return IMStatuses.ERROR.get(Messages.getString("Message_DocsProxyFeature$uuid"), Messages.getString("Message_DocsProxyFeature$explanation"),
              Messages.getString("Message_Feature$useraction"), 0, Messages.getString("Message_DocsProxyFeature$message"));
        }
      }
    }
