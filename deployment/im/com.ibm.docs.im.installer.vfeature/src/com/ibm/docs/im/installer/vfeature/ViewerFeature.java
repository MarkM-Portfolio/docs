 ...
 *
 */
public class ViewerFeature implements ISelectionExpression
{
  @Override
  public IStatus evaluate(EvaluationContext arg0)
  {
    ...
    if (arg0!=null && arg0 instanceof IAdaptable)
    {
      ...
      {        
        ...
        //Viewer
        String cfgFileDir = installationRoot + File.separator + Constants.VIEWER_LOCAL_DIR + File.separator + Constants.CONFIG_PROPERTIES_FILE;
        ...
        //Viewer Ext
        cfgFileDir = installationRoot + File.separator + Constants.VIEWER_EXT_LOCAL_DIR + File.separator + Constants.CONFIG_PROPERTIES_FILE;
        cfgfile = new File(cfgFileDir);
        if (cfgfile!=null && cfgfile.isFile())
        {
          bVExt = true;
        }
        ...
        if (!bV || !bVExt)
        {
          return IMStatuses.ERROR.get(Messages.getString("Message_ViewerFeature$uuid"), Messages.getString("Message_ViewerFeature$explanation"),
              Messages.getString("Message_Feature$useraction"), 0, Messages.getString("Message_ViewerFeature$message"));
        }
      }
    }
