 ...
 *
 */
public class DocsFeature implements ISelectionExpression
{
  @Override
  public IStatus evaluate(EvaluationContext arg0)
  {
    ...
    if (arg0!=null && arg0 instanceof IAdaptable)
    {
      ...
      {        
        ...
        //Docs
        String cfgFileDir = installationRoot + File.separator + Constants.DOCS_LOCAL_DIR + File.separator + Constants.CONFIG_PROPERTIES_FILE;
        String cfgNodeFileDir = installationRoot + File.separator + Constants.DOCS_LOCAL_DIR + File.separator + Constants.CONFIG_NODE_PROPERTIES_FILE;
        ...
        {
          int ii = 99;
          return IMStatuses.ERROR.get(Messages.getString("Message_DocsFeature$uuid"), Messages.getString("Message_DocsFeature$explanation"),
              Messages.getString("Message_Feature$useraction"), 0, Messages.getString("Message_DocsFeature$message"));
        }
      }
    }
