...
appServers = listServersOfType('APPLICATION_SERVER')
for (appNodename,appServername) in appServers:
  nodehost,port = getServerHostnamePort(appNodename,appServername,'SOAP_CONNECTOR_ADDRESS')
  if socket.gethostbyname(hostname)== socket.gethostbyname(nodehost):  
    print "SOAP::::"+ port
    break