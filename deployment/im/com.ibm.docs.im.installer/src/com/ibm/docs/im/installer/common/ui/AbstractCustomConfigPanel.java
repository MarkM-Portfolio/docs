...
public abstract class AbstractCustomConfigPanel extends CustomPanel
{
  ...
  public static final String CONVERSION_SHARED_DATA_ROOT_REMOTE_VIEWER = IProfile.USER_DATA_PREFIX
      + "conversion_shared_data_root_remote_viewer"; // NON-NLS-1
  ...
  public static final int VINDENT_DEFAULT = 10;

  public static final int VINDENT_PANEL_DEFAULT = 3;

  public static final int NONE_VINDENT = 0;  

  //Control Composite for invisible
  protected Vector<Control> controlInvisibleWidgets = new Vector<Control>();
  //Control Composite for visible
  protected Vector<Control> controlVisibleWidgets = new Vector<Control>();

  public AbstractCustomConfigPanel(String panelName)
  {
    super(panelName);
  }
  ...
  public static Label createLabel(Composite parent, String s)
  {
