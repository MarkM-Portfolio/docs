...
DOCSRP_PROPERTIES_PATH = "/opt/IBM/WebSphere/AppServer/profiles/SecureProxySrv01/properties/"
...
def restrictCiphers():
    ...
    for line in fileinput.input(DOCSRP_PROPERTIES_PATH + PROFILE_SSL_CLIENT_PROPS, backup='.bak', inplace=1):  
