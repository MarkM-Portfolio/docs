...
public class SetTableTask extends Operation 
{
	public final static String TASK_ID = "taskId";
	private String task_id;
	
	public SetTableTask(JSONObject jsonUpdate){
	...
	protected void apply(JSONObject model) throws Exception {
		...
		if (modelObj == null || !( modelObj instanceof Table )) {
			//not support yet
			throwUnSupported(model, modelObj);
		}
		Table table = (Table) modelObj;
		table.setTaskId(this.task_id);
	}
