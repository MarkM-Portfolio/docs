...
/**
 * This class is used to define the malformed request related exception.
 * The numbers(14xx) are used to indicate the malformed request related error codes.
 * 
 */
public class MalformedRequestException extends Exception
{
  ...
  /**
   * 
   * @param nErrorCode indicates the error codes that defined in this exception.
   * @param message indicates the error message
   */
