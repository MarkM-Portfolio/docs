 ...
 * @version $Revision: 1.3 $ ($Author: ruisuy $)
 */
public final class TagTable
{
    ...
    private static final Dict[] TAGS = {
        ...
        //Start SVG elements
        new Dict("svg", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("g", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("path", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("rect", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("ellipse", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("line", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("polygon", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("circle", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("altglyph", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("altglyphdef", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("altglyphitem", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("animate", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("animatecolor", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("animatemotion", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("animatetransform", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("clippath", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("color-profile", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("cursor", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("definition-src", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("defs", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("desc", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("feblend", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fecolormatrix", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fecomponenttransfer", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fecomposite", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("feconvolvematrix", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fediffuselighting", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fedisplacementmap", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fedistantlight", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("feflood", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fefunca", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fefuncb", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fefuncg", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fefuncr", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fegaussianblur", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("feimage", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("femerge", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("femergenode", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("femorphology", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("feoffset", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fepointlight", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fespecularlighting", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fespotlight", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("fetile", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("feturbulence", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("filter", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("font-face", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("font-face-format", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("font-face-name", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("font-face-src", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("font-face-uri", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("foreignobject", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("glyph", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("glyphref", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("hkern", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("image", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("lineargradient", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("marker", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("mask", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("metadata", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("missing-glyph", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("mpath", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("pattern", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("polyline", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("radialgradient", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("set", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("stop", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("switch", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("symbol", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("text", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("textpath", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("tref", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("tspan", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("use", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("view", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        new Dict("vkern", Dict.VERS_FROM32, Dict.CM_BLOCK, ParserImpl.BLOCK, null),
        // End SVG elements
        ...
        new Dict("caption", Dict.VERS_FROM32, Dict.CM_TABLE, ParserImpl.BLOCK, TagCheckImpl.CAPTION),
