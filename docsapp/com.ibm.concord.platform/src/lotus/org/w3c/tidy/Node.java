...
public class Node
{
    ...
    public static void trimSpaces(Lexer lexer, Node element)
    {
        ...
        TagTable tt = lexer.configuration.tt;
        boolean trimSpaces = lexer.configuration.trimSpace;

        if (text != null && text.type == Node.TEXT_NODE && element.tag != tt.tagPre && trimSpaces)
        {
        ...
        if (text != null && text.type == Node.TEXT_NODE && trimSpaces)
        {
