...
public class OutJavaImpl implements Out
{
    ...
    /**
     * @see lotus.org.w3c.tidy.Out#outc(int)
     */
    public void outc(int c)
    {
        try
        {
        	// non-bmp character must be converted to string 
        	// before output correct UTF-8 series bytes
        	// I think it is a java bug without consideration of
        	// non-bmp characters
            if(c >= 0x10000) { // non-bmp character
           		String s = String.valueOf(Character.toChars(c));
           		writer.write(s, 0, s.length());           
            }
            else
            	//For bmp characters, below function is right
            	writer.write(c);
        }
        catch (IOException e)
        {
    ...
    /**
     * @see lotus.org.w3c.tidy.Out#outc(byte)
     */
    ...
    /**
     * @see lotus.org.w3c.tidy.Out#newline()
     */
    public void newline()
    {
        try
    ...
    /**
     * @see lotus.org.w3c.tidy.Out#flush()
     */
    public void flush()
    {
        try
