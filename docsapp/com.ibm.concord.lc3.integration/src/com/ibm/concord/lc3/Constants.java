...
public class Constants
{
  ...
  //there is a defect in files api, when set using id, when get, got id2.
  public static final String IBM_DOCS_ID = "00000000-00000-0000-0001-00000000000000";
  public static final String IBM_DOCS_ID2 = "00000000-0000-0000-0001-000000000000";
  ...
  private static final String TD_LABEL_LOCK = "lock";
  private static final String TD_LABEL_OWNER = "owner";
  ...
  public static QName QNAME_TD_LABEL = new QName(NS_TD, TD_LABEL_LABEL, TD_PREFIX);
  ...
  public static QName QNAME_TD_LOCK = new QName(NS_TD, TD_LABEL_LOCK, TD_PREFIX);  
  public static QName QNAME_TD_OWNER = new QName(NS_TD, TD_LABEL_OWNER, TD_PREFIX);  
  public static QName QNAME_TYPE_ID = new QName(NS_TD, TD_TYPE_ID, TD_PREFIX);  

  public static QName QNAME_SN_USERID = new QName(NS_SN, USERID, SN_PREFIX);
  public static QName QNAME_SN_ORGID = new QName(NS_SN, ORGID, SN_PREFIX);
  ...
  public static QName QNAME_SN_IS_EXTERNAL = new QName(NS_SN, IS_EXTERNAL, SN_PREFIX);
