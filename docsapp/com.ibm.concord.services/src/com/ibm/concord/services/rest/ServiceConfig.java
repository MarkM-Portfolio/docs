...
public class ServiceConfig extends DefaultHandler
{
  ...
  private void parseHandlers()
  {
    ...
    try
    {
      ...
      is = getClass().getResourceAsStream("/com/ibm/concord/services/rest/service-config.xml");
  ...
  public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
  {
    if ("handler".equals(qName) && load)
    {
      ...
      Boolean needGKeeper = Boolean.valueOf(attributes.getValue("gatekeeper"));
      props.put("gatekeeper", needGKeeper);
      Boolean ownFormToken = Boolean.valueOf(attributes.getValue("formtoken"));
      props.put("formtoken", ownFormToken);
