 ...
 * 
 */
public class JoinSessionAsyncListener implements AsyncListener
{

  private static final Logger LOG = Logger.getLogger(JoinSessionAsyncListener.class.getName());
   ...
   * @param caller
   */
  public JoinSessionAsyncListener(AsyncContext asyncContext, IDocumentEntry docEntry, UserBean caller)
  {
    super();
  ...
  {
    LOG.info(new ActionLogEntry(caller, Action.ASYNC_JOIN_SESSION, docEntry.getDocUri(), " onComplete ").toString());
  }
  ...
  public void onError(AsyncEvent asyncEvent) throws IOException
  {
    ...
    LOG.info(new ActionLogEntry(caller, Action.JOINSESSION, docEntry.getDocUri(), " onError : " + asyncEvent.getThrowable().getMessage())
        .toString());
  }
  ...
  {
    LOG.info(new ActionLogEntry(caller, Action.ASYNC_JOIN_SESSION, docEntry.getDocUri(), " onStartAsync ").toString());
  }
  ...
  public void onTimeout(AsyncEvent asyncEvent) throws IOException
  {
    ...
    LOG.info(new ActionLogEntry(caller, Action.ASYNC_JOIN_SESSION, docEntry.getDocUri(), " onTimeout ").toString());
    ...
    json.put("error_msg", "Join Seesion Timeout");
