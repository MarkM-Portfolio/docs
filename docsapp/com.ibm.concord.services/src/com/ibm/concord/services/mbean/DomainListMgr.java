...
public class DomainListMgr implements DomainListMgrMBean
{
   ...
   * (non-Javadoc)
   * 
   * @see com.ibm.concord.services.mbean.DomainListMrgMBean#addDomain(java.lang.String, java.lang.String)
   */
  @Override
  public boolean addDomain(String domain)
  {
    ...
    try
    {
      ...
      Platform.getConcordConfig().addConfigList(ConfigConstants.DOMAIN_LIST_KEY, domain);
    }
    catch (Exception e)
    {
   ...
   * (non-Javadoc)
   * 
   * @see com.ibm.concord.services.mbean.DomainListMrgMBean#removeDomain(java.lang.String)
   */
  @Override
  public boolean removeDomain(String domain)
  {
    ...
    try
    {
      ...
      Platform.getConcordConfig().removeConfigList(ConfigConstants.DOMAIN_LIST_KEY, domain);
    }
    catch (Exception e)
    {
