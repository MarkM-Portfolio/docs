...
public class LoginServlet extends HttpServlet {
  ...
  private void redirect(HttpServletRequest request, HttpServletResponse response)
  {
    ...
    {  
      ...
      {
        LOG.log(Level.WARNING, "UnsupportedEncodingException when redirect: " + e);
      }
      catch (MalformedURLException e)
      {
        LOG.log(Level.WARNING, "MalformedURLException when redirect: " + e);
      }
      catch (IOException e)
      {
        LOG.log(Level.WARNING, "IOException when redirect: " + e);
      }
    }
  }
