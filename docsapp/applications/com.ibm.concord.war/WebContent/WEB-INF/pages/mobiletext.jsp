...
<link type="text/css" class="ckstyle" rel=stylesheet href="<%= contextPath + staticRootPath %>/styles/css/writer/writer.css"/>
<link type="text/css" class="ckstyle" rel=stylesheet href="<%= contextPath + staticRootPath %>/js/dijit/themes/oneui30/oneui30.css"/>
...
<body id="editorBody" class="oneui30 lotusui30 lotusui30_body onpremise bodyClass">
<div id="banner" role="banner" style="height:0px;visibility: hidden;"></div>
<div id="header" style="height:0px;visibility: hidden;"></div>
<div id="mainNode" class="wrapper" >
	<div id="ll_sidebar_div" style="height:0px;visibility: hidden;"></div>
