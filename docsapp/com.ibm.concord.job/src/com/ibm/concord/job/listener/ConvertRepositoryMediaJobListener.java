...
public class ConvertRepositoryMediaJobListener implements JobListener
{
  ...
  {
    ConvertRepositoryMediaContext listenedContext = (ConvertRepositoryMediaContext) jobContext;
    ...
    if (scanDir != null && scanDir.exists() && scanDir.isDirectory())
    {
      ...
      for (File subDir : subDirs)
      {
        ...
        {          
          File tempFile = new File(scanDir, UUID.randomUUID().toString());
