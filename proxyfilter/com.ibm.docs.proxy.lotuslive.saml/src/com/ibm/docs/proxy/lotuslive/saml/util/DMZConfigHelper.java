...
public final class DMZConfigHelper
{
  private static final Logger LOG = Logger.getLogger(DMZConfigHelper.class.getName());

  private static String ssoDomain = null;

  private static String jksFile = null;

  private static String ksShortFileName = "LotusLiveIDP.jks";
  ...
  public static final String getJksFile()
  {
    return jksFile;
  }
  ...
  private static void loadConfig()
  {
    try
    {
      ...
      if (System.getProperty("was.install.root") != null)
      {
        ...
        jksFile = (new StringBuilder()).append(rootPath).append(File.separator).append("config").append(File.separator).append("cells")
            .append(File.separator).append(cellName).append(File.separator).append("nodes").append(File.separator).append(nodeName)
            .append(File.separator).append(ksShortFileName).toString();
