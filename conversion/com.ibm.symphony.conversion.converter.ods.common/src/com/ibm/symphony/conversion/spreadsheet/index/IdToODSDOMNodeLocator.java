...
public class IdToODSDOMNodeLocator
{
...
//        traverseDOMTree(contentDom);
  ...
  public IdToODSDOMNodeLocator(ConversionContext context,com.ibm.symphony.conversion.spreadsheet.impl.ConversionUtil.Document jsonDoc,OdfDocument doc)
  {
    idNodeMap = new HashMap<String, Node>();
    styleNameMap = new HashMap<String, List<String>>();
    try
    {
      content = doc.getContentDom();
