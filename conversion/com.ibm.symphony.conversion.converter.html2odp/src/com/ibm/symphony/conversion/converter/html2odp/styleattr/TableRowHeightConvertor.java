...
public class TableRowHeightConvertor extends GeneralPropertyConvertor
{
  ...
  public void convert(ConversionContext context, OdfStyle style, Map<String, String> htmlStyle, String name, String value)
  {
    ...
    String finalValue = CSSUtil.computeMeasureByPercentage(tableHeight, value);
    style.setProperty(OdfStyleTableRowProperties.RowHeight, finalValue);
  }
}
