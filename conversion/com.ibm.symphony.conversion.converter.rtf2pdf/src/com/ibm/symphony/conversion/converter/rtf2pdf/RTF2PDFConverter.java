...
package com.ibm.symphony.conversion.converter.rtf2pdf;
...
public class RTF2PDFConverter extends AbstractFormatConverter
{

  private static Logger log = Logger.getLogger(RTF2PDFConverter.class.getName());
  ...
  public ConversionResult convert(File sourceFile, File targetFolder, Map parameters) throws ConversionException
  {
    ...
    try
    {
      symResult = SymphonyConverterImpl.getInstance().convert(sourceFile.getPath(), targetFolder.getAbsolutePath(), ConversionConstants.RTF_MIMETYPE,
  ...
  public ConversionResult convert(File sourceFile, Map parameters) throws ConversionException
  {
    ...
    File targetFolder = new File(conversionService.getRepositoryPath() + File.separator + "output" + File.separator + "rtf2pdf"
  ...
  private File getTempFolder()
  {
    ...
    File tempFolder = new File(conversionService.getRepositoryPath() + File.separator + "output" + File.separator + "rtf2pdf"
