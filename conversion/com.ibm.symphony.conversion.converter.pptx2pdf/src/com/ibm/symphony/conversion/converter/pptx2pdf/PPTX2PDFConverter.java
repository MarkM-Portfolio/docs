...
package com.ibm.symphony.conversion.converter.pptx2pdf;
...
public class PPTX2PDFConverter extends AbstractFormatConverter
{
  private static String CONVERTOR = ODPCommonUtil.createMessage(ODPCommonUtil.LOG_CONVERTOR, "PPTX", "PDF");

  @SuppressWarnings("unused")
  private static Logger log = Logger.getLogger(PPTX2PDFConverter.class.getName());
  ...
  public ConversionResult convert(File sourceFile, File targetFolder, Map parameters) throws ConversionException
  {
    ...
    try
    {
      ...
      symResult = SymphonyConverterImpl.getInstance()
          .convert(sourceFile.getPath(), targetFolder.getAbsolutePath(), PPTX_MIMETYPE, PDF_MIMETYPE, hmParms);
  ...
  public ConversionResult convert(File sourceFile, Map parameters) throws ConversionException
  {
    ...
    File targetFolder = new File(conversionService.getRepositoryPath() + File.separator + "output" + File.separator + "pptx2pdf"
