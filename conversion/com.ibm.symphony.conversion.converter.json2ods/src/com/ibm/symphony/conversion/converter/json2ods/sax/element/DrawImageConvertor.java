...
public class DrawImageConvertor
{
  ...
  public DrawImageConvertor(ConversionContext context,TransformerHandler hdl, Object input)
  {
  ...
  public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
  {
    ...
    if(input instanceof DrawFrameRange)
    {
      ...
      attrs.addAttribute("", "", ConversionConstant.ODF_ATTR_XLINK_HREF, "", src);
    }
