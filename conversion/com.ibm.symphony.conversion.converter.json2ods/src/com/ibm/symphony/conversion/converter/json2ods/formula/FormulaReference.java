...
public class FormulaReference
{
  ...
  public ArrayList<String> mNameRanges;
  ...
  public FormulaReference(JSONObject referenceJSON)
  {
    ...
    mNameRanges = new ArrayList<String>();
  }

  /**
   * Update the formula representation of the cell at (rowId, columnId) This method is used by flashing to draft document when rename/delete
   * sheet, add/delete row/column messages have been applied to draft document. Need to convert the JSON format to the formula which
   * represented by cell/range address
   * 
   * @param rowId
