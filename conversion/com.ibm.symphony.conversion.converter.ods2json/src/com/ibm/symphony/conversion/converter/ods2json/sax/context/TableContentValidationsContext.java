...
public class TableContentValidationsContext extends GeneralContext
{

  public TableContentValidationsContext(XMLImport importer, String uri, String localName, String qName, Object target)
  {
  ...
  public GeneralContext createChildContext(String uri, String localName, String qName, AttributesImpl attributes){
    ...
    switch(name){
      case TABLE_CONTENT_VALIDATION :
        context = new TableContentValidationContext(mImport, uri, localName, qName, mTarget);
        break;
      default:
