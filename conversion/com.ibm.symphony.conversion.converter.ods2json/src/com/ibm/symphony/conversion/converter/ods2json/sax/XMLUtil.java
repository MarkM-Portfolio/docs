...
public class XMLUtil
{
  ...
  public static enum NODENAME {
    ...
    TABLE_TABLE_SOURCE, //ConversionConstant.ODF_ELEMENT_TABLE_SOURCE
    ...
    TEXT_A,//ConversionConstant.ODF_ELEMENT_TEXT_A,
    TEXT_SPAN,//ConversionConstant.ODF_ELEMENT_TEXT_SPAN,
    ...
    TABLE_TABLE_FILTER_AND, //ConversionConstant.ODF_ELEMENT_TABLE_TABLE_FILTER_AND
    TABLE_TABLE_FILTER_OR, //ConversionConstant.ODF_ELEMENT_TABLE_TABLE_FILTER_OR
    ...
    TABLE_CALCULATION_SETTINGS, //ConversionConstant.ODF_ELEMENT_TABLE_TABLE_CALCULATION_SETTINGS
    TABLE_NULL_DATE, //ConversionConstant.ODF_ELEMENT_TABLE_TABLE_NULL_DATE
    DEFAULTNAME;
  }
  ...
  private static String nodeNames[] = new String[] {
      ...
      ConversionConstant.ODF_ELEMENT_OFFICE_AUTOMATIC_STYLES, 
      ConversionConstant.ODF_ELEMENT_OFFICE_BODY,
      ConversionConstant.ODF_ELEMENT_OFFICE_CHART,
      ConversionConstant.ODF_ELEMENT_OFFICE_DOCUMENT_CONTENT,
      ConversionConstant.ODF_ELEMENT_OFFICE_DOCUMENT_STYLES,
      ConversionConstant.ODF_ELEMENT_OFFICE_FONT_DECLS,
      ConversionConstant.ODF_ELEMENT_OFFICE_SCRIPTS,
      ConversionConstant.ODF_ELEMENT_OFFICE_SPREADSHEET,
      ConversionConstant.ODF_ELEMENT_DRAW_A, 
      ConversionConstant.ODF_ELEMENT_DRAW_FRAME,      
      ConversionConstant.ODF_ELEMENT_DRAW_IMAGE,
      ConversionConstant.ODF_ELEMENT_SVG_TITLE,
      ConversionConstant.ODF_ELEMENT_DRAW_OBJECT,
      ConversionConstant.ODF_ELEMENT_OFFICE_STYLES,
      ConversionConstant.ODF_ELEMENT_STYLE_FONT_FACE, 
      ConversionConstant.ODF_ELEMENT_TABLETABLE,
      ConversionConstant.ODF_ELEMENT_TABLECONVEREDTABLE_CELL, 
      ConversionConstant.ODF_ELEMENT_TABLETABLE_CELL,
      ConversionConstant.ODF_ELEMENT_TABLETABLE_COLUMN, 
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_COLUMNS,
      ConversionConstant.ODF_ELEMENT_TABLE_COLUMN_GROUP, 
      ConversionConstant.ODF_ELEMENT_TABLETABLE_ROW,
      ConversionConstant.ODF_ELEMENT_TABLE_SOURCE,
      ConversionConstant.ODF_ELEMENT_NAMED_EXPRESSION, 
      ConversionConstant.ODF_ELEMENT_NAMED_EXPRESSIONS, 
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_HEADER_COLUMNS,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_HEADER_ROWS,
      ConversionConstant.ODF_ELEMENT_NAMED_RANGE,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_ROWS, 
      ConversionConstant.ODF_ELEMENT_TABLE_ROW_GROUP,
      ConversionConstant.ODF_ELEMENT_TEXT_A,
      ConversionConstant.ODF_ELEMENT_TEXT_SPAN,
      ConversionConstant.ODF_ELEMENT_TEXT_H,
      ConversionConstant.ODF_ELEMENT_TEXT_P,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_FILTER_CONDITION,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_FILTER_AND,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_FILTER_OR,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_FILTER,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_DATABASE_RANGE, 
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_DATABASE_RANGES,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_CONTENT_VALIDATIONS,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_CONTENT_VALIDATION,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_HELP_MESSAGE,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_ERROR_MESSAGE,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_CALCULATION_SETTINGS,
      ConversionConstant.ODF_ELEMENT_TABLE_TABLE_NULL_DATE
  };
  
  private static String[] attrNames =
  {
     ConversionConstant.ODF_ATTRIBUTE_TABLE_VISIBILITY,
     ConversionConstant.ODF_ATTRIBUTE_TABLE_TABLE_FORMULA,
     ConversionConstant.ODF_ATTRIBUTE_OFFICE_VALUE_TYPE,
     ConversionConstant.ODF_ATTRIBUTE_FO_BORDER,
     ConversionConstant.ODF_ATTRIBUTE_FO_BORDER_LEFT,
     ConversionConstant.ODF_ATTRIBUTE_FO_BORDER_RIGHT,
     ConversionConstant.ODF_ATTRIBUTE_FO_BORDER_TOP,
  ...
  // get the property value of element in style, first find automatic styles in content.xml, then styles in styles.xml
  // TODO:convertor.mQName corresponding to the odf element, first check if it inherited from OdfStylableElement,
  // if yes, check xmlTokenMap contains the entry for such qName, if not, construct such entry and add it in xmlTokenMap first
  public static String getStyleProperty(ConversionContext context, GeneralContext convertor, OdfStyleProperty prop)
  {
    OdfOfficeAutomaticStyles autoStyles = (OdfOfficeAutomaticStyles) context.get("autostyles");
    String elementName = convertor.getNodeName();
    NODENAME token = getXMLToken(elementName);
    XMLTokenEntry entry = xmlTokenMap.get(token);
    if (entry == null)
      LOG.log(Level.WARNING, elementName + "might not a stylable element");
    String styleName = convertor.getAttrValue(entry.mStyleAttrName);
    OdfStyle style = autoStyles.getStyle(styleName , entry.mFamily);
    if (style == null)
    {
      OdfDocument doc = (OdfDocument) context.get("Source");
      OdfOfficeStyles styles = doc.getDocumentStyles();
      style = styles.getStyle(styleName, entry.mFamily);
    }
    if (style != null)
      // getProperty provided by odfdom will search the prop in itself, if does not exist, search it in parent style
      return style.getProperty(prop);
    return null;
    // if not construct the styles.xml dom tree, we should implement getProperty by ourself
    // get the property from style, if it does not exist, search the parent style
  }
...
class XMLTokenEntry
{
  XMLUtil.NODENAME mTokenName;// elment name

  String mStyleAttrName;// the style name of the element

  OdfStyleFamily mFamily;// element style family
