...
public class DetectorUtil
{
  ...
  public static boolean isAttrsMatch(String tagName, AttributesImpl attrs)
  {
    ...
    while (it.hasNext())
    {
      ...
      String attrValue = attrs.getValue(key);
      boolean flag = false;
      if(attrValue != null){
  ...
  public static boolean detectMacro(OdfDocument doc)
  {
    Map<String, OdfFileEntry> manifestMap = doc.getPackage().getManifestEntries();
    if (manifestMap != null && 
    	   ( manifestMap.containsKey("Basic/script-lc.xml") ||
    		 manifestMap.containsKey("Basic/script-lb.xml") ||
    		 manifestMap.containsKey("Basic/dialog-lc.xml") ||
    		 manifestMap.containsKey("Basic/dialog-lb.xml") ||
    		 manifestMap.containsKey("ConcordPreserve/_MS_VBA_Macros"))) {
    		return true;
    }    
    return false;
  }
