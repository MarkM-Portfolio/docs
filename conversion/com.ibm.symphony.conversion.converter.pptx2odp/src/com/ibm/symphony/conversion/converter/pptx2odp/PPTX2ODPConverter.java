...
package com.ibm.symphony.conversion.converter.pptx2odp;
...
public class PPTX2ODPConverter extends AbstractFormatConverter
{
  private static String CONVERTOR = ODPCommonUtil.createMessage(ODPCommonUtil.LOG_CONVERTOR, "PPTX", "ODP");

  @SuppressWarnings("unused")
  private static Logger log = Logger.getLogger(PPTX2ODPConverter.class.getName());
  ...
  public ConversionResult convert(File sourceFile, File targetFolder, Map parameters) throws ConversionException
  {
    ...
    try
    {
      ...
      symResult = SymphonyConverterImpl.getInstance()
          .convert(sourceFilename, targetFilename, ConversionConstants.PPTX_MIMETYPE, ConversionConstants.ODP_MIMETYPE,
  ...
  public ConversionResult convert(File sourceFile, Map parameters) throws ConversionException
  {
    ...
    File targetFolder = new File(conversionService.getRepositoryPath() + File.separator + "output" + File.separator + "pptx2odp"
