...
public class ConversionResult
{
  ...
  /**
   * return if the given error code already added in the conversion result
   */
  public boolean containErrCode(String errCode)
  {
    return this.featureIds.contains(errCode);
  }
}
