...
public class SharedStorageMgr implements SharedStorageMgrMBean
{
  ...
  {
    return lockMount(serverHost, sharedFrom, sharedTo, retry, timeo, StorageType.NFS);
  }

  public boolean mount(String serverHost, String sharedFrom, String sharedTo, Integer retry, Integer timeo, StorageType type)
  {
    return lockMount(serverHost, sharedFrom, sharedTo, retry, timeo, type);
  }

  private boolean lockMount(String serverHost, String sharedFrom, String sharedTo, Integer retry, Integer timeo, StorageType type)
  {
    ...
    try
    {
      ...
      while (lock == null)
      {
        if (waitCount++ > WAIT_LOCK_TIME_LIMIT_COUNT)
        {
          ...
          return this.mountStorage(serverHost, sharedFrom, sharedTo, retry, timeo, type);
        }
        try
        {
  ...
  private boolean mountStorage(String serverHost, String sharedFrom, String sharedTo, Integer retry, Integer timeo, StorageType type)
  {
    if (serverHost == null)
    {
  ...
  {
    return umount(sharedTo, StorageType.NFS);
  }
