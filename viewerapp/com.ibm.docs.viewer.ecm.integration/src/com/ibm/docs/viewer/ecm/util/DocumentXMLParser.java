...
public class DocumentXMLParser extends ECMResponseParser
{
  ...
  public static final String LOCK_OWNER_UID = IReviewable.LOCK_OWNER_UID;

  public static final String LOCK_OWNER_EMAIL = IReviewable.LOCK_OWNER_EMAIL;

  public static final String LOCK_OWNER_NAME = IReviewable.LOCK_OWNER_NAME;
  ...
  public static final String APPROVERS = IReviewable.APPROVERS;

  public static final String GLOBAL_APPROVAL_PROP = IReviewable.GLOBAL_APPROVAL_PROP;
  ...
  public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
  {
    ...
    if (qName.equalsIgnoreCase(APPROVAL_STATE_TAG) || qName.equalsIgnoreCase(APPROVAL_SCOPE_TAG)
        || qName.equalsIgnoreCase(APPROVAL_SELF_TAG) || qName.equalsIgnoreCase(APPROVAL_TYPE_TAG)
    ...
    if (qName.equalsIgnoreCase(LOCK_OWNER_UID_TAG) || qName.equalsIgnoreCase(LOCK_OWNER_EMAIL_TAG)
    ...
    if (qName.equalsIgnoreCase(AUTHOR_UID_TAG) || qName.equalsIgnoreCase(AUTHOR_EMAIL_TAG) || qName.equalsIgnoreCase(AUTHOR_NAME_TAG))
    {
      if (loadAuthor)
      {
        loadProp = qName;
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException
  {
    if (loadProp != null)
    {
      if (loadLockOwner)
      {
        ...
        {
          lockowner.put(LOCK_OWNER_UID, sb.toString());
        }
        if (loadProp.equalsIgnoreCase(LOCK_OWNER_EMAIL_TAG))
        {
          lockowner.put(LOCK_OWNER_EMAIL, sb.toString());
        }
        if (loadProp.equalsIgnoreCase(LOCK_OWNER_NAME_TAG))
        {
          lockowner.put(LOCK_OWNER_NAME, sb.toString());
        }
      }
      ...
      if (loadAuthor)
      {
        ...
        {
          author.put(LOCK_OWNER_UID, sb.toString());
        }
        if (loadProp.equalsIgnoreCase(AUTHOR_EMAIL_TAG))
        {
          author.put(LOCK_OWNER_EMAIL, sb.toString());
        }
        if (loadProp.equalsIgnoreCase(AUTHOR_NAME_TAG))
        {
          author.put(LOCK_OWNER_NAME, sb.toString());
        }
      }
