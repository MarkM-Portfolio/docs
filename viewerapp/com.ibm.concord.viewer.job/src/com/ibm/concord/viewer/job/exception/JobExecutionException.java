...
package com.ibm.concord.viewer.job.exception;
...
public class JobExecutionException extends Throwable
{
  ...
  public JobExecutionException(int errorStatus, Throwable nested)
  {
    this(nested.getClass().getSimpleName(), nested.getMessage(), nested.getLocalizedMessage(), errorStatus, nested);
