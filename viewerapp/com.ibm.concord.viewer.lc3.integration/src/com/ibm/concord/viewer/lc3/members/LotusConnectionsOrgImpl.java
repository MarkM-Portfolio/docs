...
public class LotusConnectionsOrgImpl implements IOrg
{
  private LotusConnectionsMembersModel model;
  private String id;
  private HashMap<String, String> properties;

  public LotusConnectionsOrgImpl(LotusConnectionsMembersModel model, String id, Map<String, String> properties)
  {
    this.model = model;
    this.id = id;
  ...
  public IUser getUser(String userId)
  {
    ...
    LotusConnectionsUserImpl user = null;
    try
    {
    ...
    if (dsUser != null)
    {
      user = new LotusConnectionsUserImpl(this.model, dsUser);
    }
  ...
  public List<IUser> getUsersByPropertyExactMatch(UserProperty prop, String value)
  {
    if (UserProperty.PROP_EMAIL.toString().equals(prop))
    {
      ...
      if (dsUser != null)
      {
        LotusConnectionsUserImpl user = new LotusConnectionsUserImpl(this.model, dsUser);
