...
public class MailUserImpl implements IUser
{
  ...
  public MailUserImpl(MailMembersModel model, DSObject dsUser)
  {
    this.model = model;
    if (dsUser != null)
    {
      ...
      if (orgId == null)
      {
        orgId = MailMembersModel.DEFAULT_ORG_ID;
      }
  ...
  public MailUserImpl(MailMembersModel model, String id, Map<String, String> properties)
  {
      this.model = model;
      this.id = id;
